...
<%
  ...
  CreateUI('pg1_1_2.asp', 'mainform', false, true,
      new Array(
        'submit', '查詢',
        "location.href='pg1_1_2_n.asp'", '新增'
      ),
      new Array(
...
<%
  ...
  if (!IsNull(Session('SEARCH1_WhereCon')))
  {
    BrowseData("select " +
      ...
      new Array(
          'SEND_DATE', 'DOCNO', 'IDNO', 'INDEX1', 'INDEX2_LIST', 'KEY_LIST'),
      new Array(
          '發文日期', '文號', '統一編號', '稅目', '復查項目', '關鍵字'),
      'pg1_1_2_d.asp', false, '', '', '');
  }
%>
