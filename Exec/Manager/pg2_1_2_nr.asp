...
<%
  ...
  {
    ErrorMsg('上傳檔案失敗[檔案名稱:' + FileName + '].',
        new Array('重新執行轉檔', "location.href='pg2_1_2_n.asp'", '回首頁', "location.href='pg2_1_2.asp'"));
  }

  Response.Redirect('pg2_1_2_d.asp?file_name=' + Server.URLEncode(FileName));
%>