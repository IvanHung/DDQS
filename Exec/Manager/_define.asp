<%
  ...
  // 首頁URL
  SysHomeURL = 'http://e01sr24t:8080';
  // 以Windows權限登入頁URL
  SysWindowsUserLoginURL = 'http://e01sr24t:8080/WindowsADLogin/';
  ...
  SysDBHost = "localhost\\SQLEXPRESS";
  // 系統資料庫 資料庫名稱
  SysDBDatabaseName = "NTAK_DDQS";
  // 系統資料庫 登入使用者編號
  SysDBUser = "intranet";
  // 系統資料庫 登入密碼
  SysDBPassword = "intranet";

  SysDBDatabaseNameData = "NTAK_DATA";
  ...
  // 系統紀錄檔位置  
  SysLogFilePath = "D:\\www\NTAKWeb\\NTAK_DDQS\\Exec\\Manager\\sys_admin\\log.htm";
