...
<form action="pg2_1_2_nr.asp"  enctype="multipart/form-data" method=post>
  <br>
  <b>請選擇訴願決定書檔案上傳</b><br><br><input type=file class=text name="word_file"><br><br><br>
