...
//////////////////////////////////////////////////////////////////////////////////////////
  ...
  HtmlCmd =
            WriteMenu('m1', '復查決定書',
        WriteMenuItem('pg1_1_1.asp', '資料查詢') +
        WriteMenuItem('pg1_1_2.asp', '資料維護')
      ) +
      WriteMenu('m2', '訴願決定書',
        WriteMenuItem('pg2_1_1.asp', '資料查詢') +
        WriteMenuItem('pg2_1_2.asp', '資料維護')
      ) +
      WriteMenu('m3', '行政訴訟裁判書',
        WriteMenuItem('pg3_1_1.asp', '資料查詢') +
        WriteMenuItem('pg3_1_2.asp', '資料維護')
      ) +
      WriteMenuItem('pg8_1_1.asp', '逕提訴願案件查詢')+
      WriteMenuItem('撤銷目錄及案例.asp', '撤銷目錄及案例')+
      WriteMenu('m5', '資料管理',
        WriteMenuItem('pg9_1_1.asp', '稅目維護') +
        WriteMenuItem('pg9_1_2.asp', '項目維護') +
        WriteMenuItem('pg9_1_3.asp', '關鍵字維護') +
        WriteMenuItem('pg9_1_4.asp', '作業紀錄查詢')
      ) +
