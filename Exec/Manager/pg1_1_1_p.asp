...
<tr><td align=center valign=center><table class="printtable_Protrait" border="0" cellspacing="0" cellpadding="0" width="98%" height="98%">
  <tr height="20">
    <td width="10%" style="border-style: solid; border-width: 1; border-color: black black black black;"><div align=center><font style="font: 20pt;"><b>復 查 決 定 書</b></font></div></td>
  </td>
  <tr height="20">
    ...
    復查項目: <%=IsNull(Sav.Item('INDEX2_LIST'))?'&nbsp;':Sav.Item('INDEX2_LIST')%><br>
